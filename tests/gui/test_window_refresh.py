...
def test_window_connect_pages_skips_initial_shared_load_without_game_path(monkeypatch) -> None:
    ...
    fake_window = SimpleNamespace(
        settingInterface=SimpleNamespace(
            ...
            preview_audio_output_device_changed=_FakeEmitter(),
            preview_audio_volume_changed=_FakeEmitter(),
        ...
        overviewInterface=SimpleNamespace(
            ...
            set_preview_audio_output_device=lambda value: calls.append(("set_preview_audio_output_device", value)),
            set_preview_audio_volume=lambda value: calls.append(("set_preview_audio_volume", value)),
